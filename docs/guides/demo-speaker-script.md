...
| .claude     | Conversación o `/gaia_code_generator`        | craftsman_lead + subagentes  | Pausa humana en Gherkin         |
```
...
- `.claude/commands/gaia_code_generator.md` — slash command `/gaia_code_generator` que usa el CLI por detrás.
...
- El `/gaia_code_generator` de `.claude` usa los **mismos agentes TypeScript** que el CLI.
  ...
  "slides": [
    ...
    },
    {
      ...
      "key_points": [
        ...
        ".claude: control humano en Gherkin, slash command /gaia_code_generator",
