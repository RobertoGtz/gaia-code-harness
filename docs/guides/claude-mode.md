...
> Cómo usar GAIA desde Claude Code: agentes conversacionales, aprobación humana y el slash command `/run_gaia`.
...
│   └── mutation_tester.md
├── commands/
│   └── run.md                ← Slash command `/run_gaia` para lanzar CLI Mode
├── rules/
