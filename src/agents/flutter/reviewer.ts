/**
 * @fileoverview Flutter Reviewer Agent
 * @description Validates Flutter implementation and creates GitHub PR
 */
...
/**
 * FlutterReviewerAgent: Validates Flutter implementation and creates GitHub PR
 * 
 * Uses dart analyze + flutter test for validation.
 * 
 * Input: Job with implemented code
 * Output: Validation result, PR URL
 */
export class FlutterReviewerAgent extends BaseAgent {
